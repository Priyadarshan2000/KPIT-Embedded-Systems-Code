...
CxxTest::StaticSuiteDescription suiteDescription_SampleTestSuite( "test.h", 13, "SampleTestSuite", suite_SampleTestSuite, Tests_SampleTestSuite );

static class TestDescription_suite_SampleTestSuite_testOne : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_SampleTestSuite_testOne() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 17, "testOne" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testTwo() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 24, "testTwo" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testFour() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 38, "testFour" ) {}
