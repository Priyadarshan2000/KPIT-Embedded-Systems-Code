...
public:
 TestDescription_suite_SampleTestSuite_testOne1() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 10, "testOne1" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testTwo2() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 16, "testTwo2" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testThree3() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 23, "testThree3" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testFour() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 31, "testFour" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testFive() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 37, "testFive" ) {}
