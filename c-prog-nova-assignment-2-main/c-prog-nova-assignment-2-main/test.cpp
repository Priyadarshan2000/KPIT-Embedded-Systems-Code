...
public:
 TestDescription_suite_SampleTestSuite_testTwo2() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 21, "testTwo2" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testThree3() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 29, "testThree3" ) {}
 void runTest() { suite_SampleTestSuite.testThree3(); }
} testDescription_suite_SampleTestSuite_testThree3;

static class TestDescription_suite_SampleTestSuite_testFour4 : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_SampleTestSuite_testFour4() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 35, "testFour4" ) {}
 void runTest() { suite_SampleTestSuite.testFour4(); }
} testDescription_suite_SampleTestSuite_testFour4;
